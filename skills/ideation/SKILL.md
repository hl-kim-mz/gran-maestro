...
- `provider: "claude"`: `Task(subagent_type: "general-purpose", model: "{config.models.claude.ideation}", prompt: "prompts/{roleKey}-prompt.md 파일을 Read하고 지시에 따라 분석. 결과를 opinion-{roleKey}.md에 Write. 완료 후 '완료'")`

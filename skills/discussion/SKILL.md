...
- Read로 해당 라운드 3개 파일 + 이전 synthesis를 읽음
- Write로 `rounds/NN/critique-claude.md`에 직접 저장
- 500자 이내 제한 (라운드 critique는 간결하게)

**Codex Critic** (`critic_count == 2`인 경우):
- `/mst:codex "{prompt}" --output .gran-maestro/discussion/DSC-NNN/rounds/NN/critique-codex.md`
- 500자 이내 제한

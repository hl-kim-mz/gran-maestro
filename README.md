...
```
/plugin add github:myrtlepn/gran-maestro
```
...
### Ideation — 3 AI 브레인스토밍

Codex, Gemini, Claude 3개 AI에게 동시에 의견을 수집하고 PM이 종합합니다.
...
- `opinion-codex.md`, `opinion-gemini.md`, `opinion-claude.md` — 각 AI 의견
- `synthesis.md` — PM 종합 분석 (수렴점, 발산점, 추천 방향)

### Discussion — 3 AI 합의 토론
...
| `/mst:ideation` | 3 AI 브레인스토밍 |
| `/mst:discussion` | 3 AI 합의 토론 |

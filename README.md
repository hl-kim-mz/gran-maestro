...
Codex CLI에 [oh-my-codex(OMX)](docs/omx-guide.md)를 설치해
프롬프트 라우팅과 스킬 트리거를 활성화합니다.
한 번의 명령으로 설치·초기화·AGENTS.md 주입까지 자동 처리됩니다.

```
/mst:setup-omx
```

자세한 내용: [docs/omx-guide.md](docs/omx-guide.md)

## 스킬 목록

28개 스킬을 카테고리별로 제공합니다.

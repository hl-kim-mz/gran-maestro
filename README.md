...
[oh-my-codex(OMX)](docs/omx-guide.md)를 연동하면 역할 기반 에이전트 자동 분기, 워크플로우 스킬 트리거, 팀 모드 병렬 실행으로 Codex CLI의 출력 품질이 눈에 띄게 향상됩니다.

```
/mst:setup-omx
```

[OMX 장점 더 보기 →](docs/omx-guide.md)

## 스킬 목록

29개 스킬을 카테고리별로 제공합니다.
